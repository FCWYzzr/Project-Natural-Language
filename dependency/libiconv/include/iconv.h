...
#endif
extern std::size_t iconv (iconv_t cd,  char* * inbuf, std::size_t *inbytesleft, char* * outbuf, std::size_t *outbytesleft);
...
typedef void (*iconv_unicode_mb_to_uc_fallback)
             (const char* inbuf, std::size_t inbufsize,
              void (*write_replacement) (const unsigned int *buf, std::size_t buflen,
                                         void* callback_arg),
              void* callback_arg,
              void* data);
...
typedef void (*iconv_unicode_uc_to_mb_fallback)
             (unsigned int code,
              void (*write_replacement) (const char *buf, std::size_t buflen,
                                         void* callback_arg),
              void* callback_arg,
              void* data);
...
typedef void (*iconv_wchar_mb_to_wc_fallback)
             (const char* inbuf, std::size_t inbufsize,
              void (*write_replacement) (const wchar_t *buf, std::size_t buflen,
                                         void* callback_arg),
              void* callback_arg,
              void* data);
