...
namespace antlr4 {
  ...
  public:
    ...
    virtual std::unique_ptr<CommonToken> create(std::pair<TokenSource*, CharStream*> source, std::size_t type,
      const std::string &text, std::size_t channel, std::size_t start, std::size_t stop, std::size_t line, std::size_t charPositionInLine) override;
