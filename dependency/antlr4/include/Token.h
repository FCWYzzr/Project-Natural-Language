...
namespace antlr4 {
  ...
  public:
    static constexpr std::size_t INVALID_TYPE = 0;

    /// During lookahead operations, this "token" signifies we hit rule end ATN state
    /// and did not follow it despite needing to.
    static constexpr std::size_t EPSILON = std::numeric_limits<size_t>::max() - 1;
    static constexpr std::size_t MIN_USER_TOKEN_TYPE = 1;
    static constexpr std::size_t EOF = IntStream::EOF;
    ...
    static constexpr std::size_t DEFAULT_CHANNEL = 0;

    /// Anything on different channel than DEFAULT_CHANNEL is not parsed
    /// by parser.
    static constexpr std::size_t HIDDEN_CHANNEL = 1;
     ...
     */
    static constexpr std::size_t MIN_USER_CHANNEL_VALUE = 2;
