...
namespace atn {
  ...
  public:
    ...
    static Ref<const SingletonPredictionContext> create(Ref<const PredictionContext> parent, std::size_t returnState);
    ...
    const std::size_t returnState;

    SingletonPredictionContext(Ref<const PredictionContext> parent, std::size_t returnState);
